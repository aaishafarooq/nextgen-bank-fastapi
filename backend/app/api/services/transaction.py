    ...
    try:
        ...
        if risk_analysis.get("needs_review", False):
            ...
            raise HTTPException(
                ...
                detail={
                    "status": "error",
                    "message": "This transaction has been flagged as potentially fraudulent. An account executive "
    ...
    try:
        ...
        try:
            ...
            try:
                ...
                logger.info(
                    f"Successfully sent withdrawal approval notificatoin for transaction {transaction.reference}"
                )
            except Exception as e:
